...
return {
  ...initialForm,
  clienteNombre: localStorage.getItem("st_nombre") || "",
  clienteTelefono: localStorage.getItem("st_telefono") || "",
  clienteEmail: localStorage.getItem("st_email") || "",
};
...
try {
  ...
  localStorage.setItem("st_nombre", form.clienteNombre.trim());
  localStorage.setItem("st_telefono", form.clienteTelefono.trim());
  localStorage.setItem("st_email", form.clienteEmail.trim());
...
Dinos dónde estás y a dónde vas. En minutos tendrás un taxi.
</p>
</div>
